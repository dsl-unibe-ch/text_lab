...
if uploaded_file is not None:
    ...
    try:
        ...
        st.info(f"Processing `{uploaded_file.name}`... This may take a few minutes.")
        ...
        with st.spinner("Running OCR... This can be slow for large documents."):
        ...
        if JOB_DIR.exists():
            try:
                ...
                st.info(f"Cleaned up temporary job directory: {JOB_DIR}")
            except Exception as e:
